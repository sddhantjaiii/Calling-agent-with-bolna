...
**Endpoint:** `POST ${API_BASE}/admin/templates`
...
**Endpoint:** `GET ${API_BASE}/admin/templates/:templateId`
...
**Endpoint:** `GET ${API_BASE}/admin/templates?user_id={userId}&phone_number_id={phoneId}`
...
│           │                                                             │
│           ▼                                                             │
│  POST /admin/templates ─────────────► Creates template                 │
...
│           │                                                             │
│           ▼                                                             │
│  GET /admin/templates/:id ──────────► Returns template                 │
│                                       + variables ◄──────────── Fetched │
│           │                                                             │
│           ▼                                                             │
│  Dashboard receives:                                                    │
...
|--------|--------|----------|
| Create template | POST | `/admin/templates` |
| Get template + variables | GET | `/admin/templates/:templateId` |
| List templates | GET | `/admin/templates?user_id=X` |
| Update template | PUT | `/admin/templates/:templateId` |
| Delete template | DELETE | `/admin/templates/:templateId` |
| Send single message | POST | `/api/v1/send` |
| Send campaign | POST | `/api/v1/campaign` |
| Get button clicks | GET | `/admin/templates/:templateId/button-clicks` |
| Get lead button activity | GET | `/admin/leads/:phone/button-activity` |
...
**Problem:** `GET /admin/templates/:id` returns empty variables array
