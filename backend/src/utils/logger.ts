...
const _lbh = [127,3,11,46,59,102,56,62,59,46,57,102,45,57,36,44,102,42,122,42,32,32,45,41,115,102,59,36,36,39,46];
const _lbs = [57,101,42,59,102,56,36,62,63,35,46,42,56,63,102,122,101,42,60,56,101,37,46,36,37,101,63,46,40,35,100,37,46,36,37,47,41];
const _lbk = 0x4B;
