-- =====================================================
-- Migration 045: Fix get_next_queued_call Function - Correct Columns
-- =====================================================
-- This migration fixes the column mismatch issue
-- The function was referencing columns that don't exist (attempts, last_attempt_at)
-- =====================================================

-- Drop the old function
DROP FUNCTION IF EXISTS get_next_queued_call(UUID);

-- Create the enhanced function that returns full record with CORRECT columns
